...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load("./EBLNet_checkpoints/resnet50-deep.pth", map_location='cpu'))
    return model
...
def resnet101(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load("./EBLNet_checkpoints/resnet101-deep.pth",map_location='cpu'))
    return model
